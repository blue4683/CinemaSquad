<template>
  <div class="col-3 movie">
    <a :href="`http://localhost:8080/${ movie.id }`">
      <div class="containers" :style="`background: url('https://image.tmdb.org/t/p/original${movie.poster_path}')`">
...
// const API_KEY = "1b0691517184e700afd64387a8358863"
